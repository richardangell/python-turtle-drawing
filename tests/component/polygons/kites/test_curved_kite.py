...
from python_turtle_art.polygons.kites import CurvedKite
...
def test_curved_kite(setup_screen_with_squares_background):
    ...
    CurvedKite.from_origin_and_dimensions(
        ...
        off_lines=(
            ...
            OffsetFromLine(0.3, -10),
            OffsetFromLine(0.4, -10),
    ...
    expected_image_file = Path(
        "tests/component/polygons/kites/expected_curved_kite.png"
    )
